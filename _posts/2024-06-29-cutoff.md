---
layout: post
title: Parsing the Cutoff Phenomenon
...
<span class="env-title">Definition (Cutoff).</span> A family of Markov Chains has a cutoff time $t_n$ with window $w_n$ if $w_n = o(t_n)$ and
